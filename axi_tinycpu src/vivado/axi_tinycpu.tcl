proc getPresetInfo {} {
  return [dict create name {axi_tinycpu} description {axi_tinycpu}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {axi_tinycpu} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 {0.029}  \
    CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 {0.030}  \
    CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 {-0.002}  \
    CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_3 {-0.011}  \
    CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.345}  \
    CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.345}  \
    CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {0.270}  \
    CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {0.272}  \
